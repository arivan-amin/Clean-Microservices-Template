...
import com.arivanamin.app.name.backend.testing.architecture.bases.BaseIntegrationTest;
...
import static com.arivanamin.app.name.backend.testing.architecture.rules.CleanArchitectureRules.*;
